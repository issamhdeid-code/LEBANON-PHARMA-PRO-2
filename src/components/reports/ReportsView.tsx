...
export const ReportsView: React.FC = () => {
  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto bg-[#f8fafc] dark:bg-slate-950 p-3.5 space-y-3 select-none">
      {/* Header & Subtabs */}
      <div className="flex flex-col gap-2.5 rounded border border-gray-200 bg-white p-3 shadow-2xs dark:border-slate-800 dark:bg-slate-900 no-print">
        ...
        {/* Subtabs Bar */}
        <div className="flex space-x-4 border-b border-gray-100 dark:border-slate-800 pt-1">
          <button
