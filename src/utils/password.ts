// Lightweight, dependency-free synchronous SHA-256.
// Used to store user password hashes instead of plaintext. Synchronous on purpose:
// the renderer is sandboxed (no Node crypto) and the login flow is synchronous.
